...
public class FigureT extends AbsFigure{
    ...
    void initStates(){
        ...
        states[2][0].set(center.line(), center.column()-1);
        states[2][1].set(center.line(), center.column());
        states[2][2].set(center.line(), center.column()+1);
        states[2][3].set(center.line()-1, center.column());
