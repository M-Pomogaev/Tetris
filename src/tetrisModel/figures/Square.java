...
public class Square extends AbsFigure{
    ...
    void initStates(){
        ...
        states[0][2].set(center.line()+1, center.column()+1);
        states[0][3].set(center.line(), center.column()+1);

        states[1][0].set(center.line()+1, center.column());
        states[1][1].set(center.line(), center.column());
        states[1][2].set(center.line()+1, center.column()+1);
        states[1][3].set(center.line(), center.column()+1);

        states[2][0].set(center.line()+1, center.column());
        states[2][1].set(center.line(), center.column());
        states[2][2].set(center.line()+1, center.column()+1);
        states[2][3].set(center.line(), center.column()+1);

        states[3][0].set(center.line()+1, center.column());
        states[3][1].set(center.line(), center.column());
        states[3][2].set(center.line()+1, center.column()+1);
        states[3][3].set(center.line(), center.column()+1);
    }
    public Square(){
